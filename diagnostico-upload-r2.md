...
- AWS SDK S3 Presigned URLs: https://docs.aws.amazon.com/AmazonS3/latest/userguide/PresignedUrlUploadObject.html
- Presigned URLs são método-específicas: não é possível reutilizar uma URL PUT para HEAD/GET
