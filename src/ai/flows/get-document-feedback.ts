...
const GetDocumentFeedbackOutputSchema = z.object({
  feedback: z
    .string()
    .describe('The detailed and exhaustive feedback generated by the AI in Markdown format.'),
});
...
Analise os documentos disponíveis e forneça um feedback detalhado e exaustivo com base no prompt do sistema.
